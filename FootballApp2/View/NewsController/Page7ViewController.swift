...
class Page7ViewController: UITableViewController,SegementSlideContentScrollViewDelegate {
   ...
   override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
    ...
    func getdata(){
        ...
        let text = "https://newsapi.org/v2/everything?q=プレミアリーグ リバプール&language=jp&sortBy=publishedAt&apiKey=1958c16c0cae44cf94156f4e04c2144d&pageSize=50"
