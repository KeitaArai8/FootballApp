...
class Chat4ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,ChatDelegate {
    ...
    override func viewDidLoad() {
        ...
        ChatClass.fetchComment(roomId: "BundesLiga")
