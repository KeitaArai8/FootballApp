...
class Chat5ViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate,ChatDelegate {
    ...
    @IBOutlet weak var sendButton: UIButton!
        ...
        self.navigationItem.title = "CL掲示板"
        self.navigationController?.navigationBar.titleTextAttributes = [.foregroundColor: UIColor.white]
        self.navigationController?.navigationBar.tintColor = .white
        
        ChatClass.fetchComment(roomId: "ChanpionsLegue")
    ...
    @IBAction func sendAction(_ sender: Any) {
        ...
        SaveComment(roomId: "ChanpionsLegue")
